...
public class RepurposeTests : TestBase
{
    ...
    public async Task Simple_text_works()
    {
        ...
        var result = await actions.RepurposeContent(content, instructions, null, null, new GlossaryRequest { });
    ...
    public async Task Simple_txt_works()
    {
        ...
        var result = await actions.RepurposeFile(new FileRequest { File = file }, instructions, null, null, new GlossaryRequest { });
        Console.WriteLine(result.RepurposedText);
        Assert.IsNotNull(result.RepurposedText);
    }
